   ...
   // @observable tagListChn = [{name:''}];
    ...
    loadMovies = flow(function* loadMovies() {
        this.listState = ListState.Loading;
         ...
         const list = [{gift_idx:1001, point_name:'明星糖果', point_type:"GIFT", point_price:1000.0000 },
        	 {gift_idx:1002, point_name:'蝙蝠', point_type:"GIFT", point_price:2000.0000 },
        	 {gift_idx:1001, point_name:'明星糖果2', point_type:"GIFT", point_price:1000.0000 },
        	 {gift_idx:1002, point_name:'蝙蝠4', point_type:"GIFT", point_price:2000.0000 },
        	 ];
    ...
    loadMovieDetail = flow(function* loadMovieDetail() {
        this.listState = ListState.Loading;
         ...
         const list = {
        			...
        			mov_Id: 1001,
        			mov_name: '明星糖果',
        			mov_name_eng: 'Star Candy',
        			mov_name_jpn: 'こんぺいとう',
        			mins: '01:45:00',
        			photo_url: '/images/gift1.png',
        			play_cnt: '',
        			play_cnt_str: '',
        			down_cnt: '',
        			has_down: false,			
        			...
        			mov_desc: '明星糖果是最受欢迎的礼物。。',
        			mov_desc_eng: 'Star candy is the most popular gift.',
        			mov_desc_jpn: 'こんぺいとうは最高人気の贈り物である。',
        			is_mosaic: '',
        			mov_score: '',
        			gift_total: '',
        			show_yn: 0,
